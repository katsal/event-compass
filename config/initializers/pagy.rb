...
Pagy::DEFAULT[:template] = '<nav class="pagy-nav pagination"><span class="page prev"><%= link %></span> <span class="page active"><%= page %></span> <span class="page next"><%= link %></span></nav>'
